...
const N = T.GATE_N, So = T.GATE_S, E = T.GATE_E

export const REGION_AZURIA = {
  id: 'city_azuria',
  regionType: 'city',
  name: 'Azuria City',
  gymId: 2,
  ...
  spawnY: 1,
  gates: {
    north: { targetRegion: 'route_1', spawnX: 9, spawnY: 13 },
    east:  { targetRegion: 'route_3', spawnX: 1, spawnY: 7, requiredBadge: 'Felsorden' },
    south: { targetRegion: 'route_5', spawnX: 9, spawnY: 1, requiredBadge: 'Quellorden' },
  },
  tiles: [
    [X,X,X,W,W,W,W,W,N,N,N,N,W,W,W,W,X,X,X,X],
