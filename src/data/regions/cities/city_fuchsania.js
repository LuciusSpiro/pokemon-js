...
export const REGION_FUCHSANIA = {
  ...
  spawnY: 7,
  gates: {
    north: { targetRegion: 'route_8', spawnX: 9, spawnY: 13 },
    west:  { targetRegion: 'route_10', spawnX: 18, spawnY: 7 },
    south: { targetRegion: 'route_11', spawnX: 9, spawnY: 1, requiredBadge: 'Seelenorden' },
  },
  tiles: [
