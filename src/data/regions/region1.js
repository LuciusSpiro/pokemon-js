...
export const REGION_1 = {
  ...
  spawnY: 13,
  gates: {
    north: { targetRegion: 2, spawnX: 9, spawnY: 13 },
    east:  { targetRegion: 3, spawnX: 1, spawnY: 7 },
  },
  tiles: [
    ...
    [X,G,G,_,_,P,P,_,_,P,P,_,_,P,P,_,_,G,_,X],
    [X,G,_,_,_,P,_,_,_,P,P,_,_,_,P,_,_,_,_,X],
    [X,_,_,_,S,P,_,F,_,P,P,_,F,_,P,_,_,_,_,X],
    [X,_,_,P,P,P,_,_,_,P,P,_,_,_,P,P,P,_,_,X],
    [X,G,G,P,_,_,G,G,_,P,P,_,G,G,_,_,P,G,G,E],
    [X,G,G,P,_,G,G,G,_,P,P,_,G,G,G,_,P,G,G,E],
